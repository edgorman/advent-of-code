    ...
    class Scanner
    {
        ...
        public List<Scanner> GetAllOrientations()
        {
            ...
            foreach (var beacon in beacons)
            {
                ...
                orientations[1].AddBeacon(new Beacon(y, z, x));
                orientations[2].AddBeacon(new Beacon(z, x, y));
                orientations[3].AddBeacon(new Beacon(-x, z, y));
                orientations[4].AddBeacon(new Beacon(z, y, -x));
                orientations[5].AddBeacon(new Beacon(y, -x, z));
                orientations[6].AddBeacon(new Beacon(x, z, -y));
                orientations[7].AddBeacon(new Beacon(z, -y, x));
                orientations[8].AddBeacon(new Beacon(-y, x, z));
                orientations[9].AddBeacon(new Beacon(x, -z, y));
                orientations[10].AddBeacon(new Beacon(-z, y, x));
                orientations[11].AddBeacon(new Beacon(y, x, -z));
                orientations[12].AddBeacon(new Beacon(-x, -y, z));
                orientations[13].AddBeacon(new Beacon(-y, z, -x));
                orientations[14].AddBeacon(new Beacon(z, -x, -y));
                orientations[15].AddBeacon(new Beacon(-x, y, -z));
                orientations[16].AddBeacon(new Beacon(y, -z, -x));
                orientations[17].AddBeacon(new Beacon(-z, -x, y));
                orientations[18].AddBeacon(new Beacon(x, -y, -z));
                orientations[19].AddBeacon(new Beacon(-y, -z, x));
                orientations[20].AddBeacon(new Beacon(-z, x, -y));
                orientations[21].AddBeacon(new Beacon(-x, -z, -y));
                orientations[22].AddBeacon(new Beacon(-z, -y, -x));
                orientations[23].AddBeacon(new Beacon(-y, -x, -z));
            }
